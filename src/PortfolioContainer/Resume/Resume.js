...
import {
  ...
  FaProjectDiagram,
  FaHeart,
} from "react-icons/fa"; // Import icons for each section
import "./Resume.css";
  ...
  return (
    <div id="resume" className="resume-container">
      ...
      <div className="resume-content">
        ...
        <div className="resume-section">
          <h3>
            <FaBriefcase className="icon" /> Work History
          </h3>
          <p>
            Software Developer
            <br />
        ...
        <div className="resume-section">
          <h3>
            <FaCode className="icon" /> Programming Skills
          </h3>
          <ul>
            <li>React</li>
            <li>Node.js</li>
        ...
        <div className="resume-section">
          <h3>
            <FaHeart className="icon" /> Interests
          </h3>
          <p>
